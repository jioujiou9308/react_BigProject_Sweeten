    ...
    <>
      <div className="h-[2000px]">
        <div className="relative z-20 w-4/5 m-auto">
          <img
            className="relative z-20 object-cover w-full rounded-sm max-h-80"
            src={"/images/course/hand.jpg"}
            alt=""
          />

          <div className="absolute z-30 w-5/6 text-center text-white -translate-x-1/2 bg-black rounded-sm top-1/2 left-1/2 md:w-2/3 md:left-1/3">
        ...
        <div className="relative z-50 w-2/3 m-auto mb-10 bg-orange-700 rounded-sm h-1/4">
          <img
            className="absolute object-cover w-full h-full rounded-sm -translate-x-1/4 z-70 -translate-y-1/4"
            src={"/images/product/green.jpg"}
            alt=""
          />
          <div className="absolute right-0 w-3/4 translate-y-1/2 bg-white rounded-sm translate-x-1/4 bottom-1/2 h-3/4">
