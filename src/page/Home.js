        ...
        <section className="overflow-hidden h-60vh relative">
          ...
          <div className="hidden md:block">
            <div className="max-w-full">
                <img className="max-w-full h-auto absolute bottom-(-30vh)" src={require("../images/bg.png")} alt=""/>
            </div>
            <h1 className="absolute text-5xl bottom-8 left-6">
              <b>為了您，<br/>&nbsp;&nbsp;&nbsp;打造精彩的甜食饗宴</b>
            </h1>
            {/* 施工 */}
            <div class="mask h-full bg-light z-1 absolute text-center row justify-content-around">
