...
const Home = (props) => {
  ...
  return (
    <WhileLoad
      onLoad={<div className=""><img src={load} className="justify-center w-1/2 animate__animated animate__lightSpeedInRight top-1/2" alt=""/><div className="z-50 w-full h-full opacity-50 bg-dark"></div></div>}
      done={
        <>
          {/* 輪播 */}
          ...
          <section className="px-4 py-8 lg:px-20 md:px-6 md:py-12">
            <div className="items-center justify-around lg:flex">
              ...
              >
                ...
                <h1
                  className="relative text-4xl font-semibold leading-9 "
                  data-aos="zoom-in-up"
                  data-aos-easing="ease-in"
                  data-aos-duration="1000"
                >
          ...
          <section
            className="px-4 2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9"
            data-aos="fade-left"
            data-aos-offset="500"
            data-aos-easing="ease-in"
