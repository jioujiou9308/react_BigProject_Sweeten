    ...
    <WhileLoad
      onLoad={
        ...
        <>
          ...
          <div
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/images/home/bg1.png)`,
          ...
          >
            ...
            <section className="relative flex items-center min-h-screen mt-20">
              <img
                ...
                className="absolute left-0 top-0 h-[20vw] -translate-x-1/2 "
                alt="background"
              />
              <img
                src="./images/home/cake007.png"
                className="absolute right-0 bottom-0 h-[20vw] translate-x-1/2"
                alt="background"
              />
          ...
          <div
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/images/home/bgpic2.jpg)`,
                    ...
                    <div>
                      ...
                      >
                        <p className="mb-3">
                          Q: 請問有實體門市嗎?
                          <br />
                          A: 有的，和手作 DIY 課程的地址相同，位於中華路二段 55
                          號
                        </p>
                        <hr />
                        <p className="my-3">
