...
const Home = (props) => {
  ...
  return (
    <WhileLoad
      onLoad={
        <div className="relative flex items-center h-screen opacity-50 ">
          <img
            src={load}
            className="fixed z-50 object-cover w-full md:w-1/2 animate__animated animate__lightSpeedInRight "
            alt=""
          />
